...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.residual_lr_init = 0.0025
        self.residual_lr_final = 0.000025
        self.residual_lr_max_steps = 15000
        self.residual_lr_min_steps = 0
...
def get_combined_args(parser : ArgumentParser):
    ...
    if args_cmdline.name is not None:
        args_cmdline.model_path = os.path.join("./output/", args_cmdline.name)
    try:
